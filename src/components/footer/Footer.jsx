  ...
  const itemsTwo = [
    {
      ...
      children: [
        { key: "services", label: <Link to="/services">Services</Link> },
        {
          ...
          label: (
            <Link to="/fundraising-get-involved">
        ...
        {
          key: "auction",
          label: <Link to="/auction">Auction Listing & Sale</Link>,
        },
        {
          key: "survivors",
        ...
        <div className="max-w-[1074px]   mx-auto">
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-0 justify-between items-center lg:items-start">
            ...
            <div className="text-center mt-4 lg:text-left">
              ...
              <h1 className=" text-[#4B5557] my-2 font-bold text-xl ">
                Virtue Hope C.I.C
              </h1>
              <h1 className=" text-[#4B5557] my-2 ">
            ...
            <div className="w-full lg:w-auto text-center mt-3 lg:text-left">
              ...
              <div className="flex flex-col lg:flex-row items-center gap-3 mt-4">
                <input
                  type="email"
                  name="email"
                  value={email} // ✅ This line is key!
                  onChange={(e) => setEmail(e.target.value)}
                  className="border border-[#0A0D120D] hover:outline-0 focus:outline-none py-2 shadow-md shadow-[#D5D7DA] bg-[#f4f5f7] px-3 border-black"
                  placeholder="Enter your email address"
                />
                <button
                  onClick={handleSubmit}
                  className="px-6 py-2 cursor-pointer rounded text-sm font-bold text-white bg-[#403730] flex items-center justify-center min-w-[120px]"
                  disabled={loading}
                >
                  {loading ? (
