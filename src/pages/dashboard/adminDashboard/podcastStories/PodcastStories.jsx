              ...
              >
                ...
                >
                  <div style={{ cursor: "pointer" }} className="flex flex-col items-center">
                    ...
                    <span className="mt-2 text-[#fff]">Upload guest photo</span>
                  </div>
                </Upload>
              </Form.Item>
            </div>
            ...
            <div className="flex justify-center border-2 border-dashed border-[#B6B6BA] rounded-md mb-2 pt-5">
              ...
              >
                ...
                >
                  <div style={{ cursor: "pointer" }} className="flex flex-col items-center">
                    <UploadCloud className="w-5 h-5 text-gray-400" />
                    <span className="mt-2 text-[#fff]">Upload host photo</span>
                  </div>
                </Upload>
              </Form.Item>
            </div>
            ...
            <div className="flex justify-center border-2 border-dashed border-[#B6B6BA] rounded-md mb-2 pt-5">
              ...
              >
                ...
                >
                  <div style={{ cursor: "pointer" }} className="flex flex-col items-center">
                    <UploadCloud className="w-5 h-5 text-gray-400" />
                    <span className="mt-2 text-[#fff]">Upload thumbnail.</span>
                  </div>
                </Upload>
              </Form.Item>
            </div>
