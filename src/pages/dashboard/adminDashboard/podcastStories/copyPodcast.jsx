...
const PodcastStories = () => {
  ...
  const onFinishOne = async (values) => {
     if (!mp3File) {
      return console.error('No MP3 file selected');
    }
    ...
    const hostImageFile = values.host_image?.[0]?.originFileObj;
    const guestImageFile = values.guest_image?.[0]?.originFileObj;

    if (hostImageFile) formData.append("host_image", hostImageFile);
    if (guestImageFile) formData.append("guest_image", guestImageFile);
          ...
          <Form form={formOne} onFinish={onFinishOne}>
              ...
              <div className="w-full">
                ...
                >
                  <Upload
                    ...
                    maxCount={1}
                  >
                    <Button>Upload Host Image</Button>
                  </Upload>
                </Form.Item>
              </div>
              ...
              <div className="w-full ">
                ...
                >
                  <Upload
                    ...
                    maxCount={1}
                  >
                    <Button>Upload Guest Image</Button>
                  </Upload>
                </Form.Item>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="inline-block">
                <Upload
                  beforeUpload={(file) => {
                    if (file.type !== 'audio/mpeg') {
                      message.error('Only MP3 files allowed!');
                ...
                >
                  <div className=" border border-dashed p-4 rounded-md text-center cursor-pointer text-white w-fit">
              ...
              <div className="inline-bloc">
                <Upload
                  ...
                  showUploadList={false}
                >
                  <div className="w-full border border-dashed p-4 rounded-md text-center cursor-pointer text-white">
                    <UploadOutlined className="text-xl" />
