...
const TermPage = () => {
  return (
    <div className="pt-20 max-w-[1216px] mx-auto pb-24 px-4  ">
      ...
      <h1 className="text-center mt-6 text-[#263234] lg:leading-16 text-3xl lg:text-5xl font-semibold  ">
      ...
      <div>
        <p className=" my-3 text-2xl text-[#263234] font-medium ">
      ...
      <div>
        <p className=" font-semibold text-xl lg:text-2xl leading-9 mt-4 lg:mt-12 ">
          {" "}
          1. Eligibility
        </p>
        <span className=" text-[#263234] leading-8 text-lg lg:text-xl mt-2 lg:mt-5 block ">
      ...
      <div className="mt-4 lg:mt-12">
        ...
        <span className=" text-[#263234] leading-8 text-lg lg:text-xl block lg:mt-5 ">
          We accept donations of high-value items (art, antiques, collectibles,
          etc.) to support our charitable mission.
        </span>
        <p className="text-[#263234] text-[16px] lg:text-xl leading-8 font-semibold my-2 lg:my-5 ">
          Upon sale of a donated item:
        </p>

        <ul className=" list-disc ml-5 text-[#263234]  leading-8 text-lg lg:text-xl block lg:mt-5 ">
          <li className="  ">
        ...
        <p className="text-[#263234] text-[16px] lg:text-xl leading-8 lg:mt-7 mt-2 ">
      ...
      <div className="mt-4 lg:mt-12">
        ...
        <p className="text-[#263234] text-[16px] lg:text-xl leading-8 font-semibold my-2 lg:my-5 ">
          All donated items will be subject to an evaluation process, which may
          include:
        </p>
        ...
        <ul className=" list-disc ml-5 text-[#263234]  leading-8 text-lg lg:text-xl block lg:mt-5  ">
          ...
          <li>
            Expected Sale Price: Based on current market conditions and similar
            items.
          </li>
          <li>
      ...
      <div className="mt-4 lg:mt-12">
        ...
        <ul className=" list-disc ml-5 text-[#263234]  leading-8 text-lg lg:text-xl block lg:mt-5 ">
          <li>
            {" "}
            You agree to transfer ownership of the item to Virtue Hope, unless a
            consignment agreement is explicitly made.
          </li>
          <li>
            {" "}
      ...
      <div className="mt-4 lg:mt-12">
        ...
        <p className="text-[#263234] text-[16px] lg:text-xl leading-8 font-semibold my-2 lg:my-5  ">
          ...
          Virtue Hope’s charitable objectives, which include the development of
          our wellbeing retreats, therapeutic programs, and outreach for
      ...
      <div className="mt-4 lg:mt-12">
        ...
        <p className="text-[#263234] text-[16px] lg:text-xl leading-8 font-semibold my-2 lg:my-5 ">
          ...
          used for marketing and promotional purposes. By submitting, you grant
          us a royalty-free, worldwide license to use these materials.
        </p>
      </div>
      ...
      <div className="mt-4 lg:mt-12">
        ...
        <ul className=" list-disc ml-5 text-[#263234]  leading-8 text-lg lg:text-xl block lg:mt-5 ">
          <li>
            Damage or loss of items during transit (unless we arranged shipping)
          </li>
      ...
      <div className="mt-4 lg:mt-12">
        ...
        <p className="text-[#263234] text-lg lg:text-xl leading-8 font-semibold my-2 lg:my-5  ">
      ...
      <div className=" mt-4 lg:mt-12">
        ...
        <p className="text-[#263234] text-lg lg:text-xl leading-8 font-semibold my-2 lg:my-5 ">
          ...
          of England and Wales. Any disputes will be subject to the exclusive
      ...
      <div className=" mt-4 lg:mt-12">
        ...
        <div>
          <p className="text-[#263234]  leading-8 text-lg lg:text-xl block  ">
            Email: give@virtuehope.com
          </p>
          <p className="text-[#263234]  leading-8 text-lg lg:text-xl block lg:mt-2 ">
          ...
          <p className="text-[#263234]  leading-8 text-lg lg:text-xl block lg:mt-2 ">
            13. 13. Limitation of Liability – Therapeutic Services
          </p>
        </div>
        <div className=" my-2 ">
          <p className="text-[#263234]  leading-8 text-lg lg:text-xl block  ">
            Virtue Hope C.I.C. is committed to providing compassionate,
            trauma-informed therapeutic support and wellbeing services delivered
            by trained staff and trusted professionals. However, the
        ...
        <div>
          ...
          <ul className=" list-disc ml-5 text-[#263234]  leading-8 text-lg lg:text-xl block lg:mt-3 ">
            <li>
            ...
            <li>
              ...
              participation in its services or any decision made based on those
              services.
            </li>
            <li>
               Virtue Hope’s services are not a substitute for professional
              clinical treatment or crisis support. In cases of emergency, users
              are encouraged to contact appropriate medical or emergency
              services.
            </li>
          </ul>
          <p className="text-[#263234] text-[16px] lg:text-xl leading-8 lg:mt-7 mt-2">
          By engaging with Virtue Hope’s services, users agree to hold the organisation and its team inoffensive from any claims arising from participation, unless caused by proven negligence or misconduct.
        </p>
        </div>
      </div>
    </div>
