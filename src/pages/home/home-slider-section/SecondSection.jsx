...
import { bidSuccessMsg } from "../../../helper/bidSuccessMsg";
...
const SecondSection = () => {
  ...
  return (
    <div>
      <div className=" bg-[#ecebea] ml-5 lg:h-[70vh] rounded-2xl ">
                ...
                <div className="flex items-center">
                  <div>
                    ...
                    >
                      ...
                      Bid online {selectedValue !== "None" ? selectedValue : ""}
                    </button>
                  </div>
                  <div>
                    <Dropdown
      ...
      >
        ...
        <div className="flex items-center" >
          ...
          <div>
            <h1 className="text-[#263234] text-[16px] " >You won’t be charged until won the bid <br /> called.</h1>
          </div>
        </div>
        <form onSubmit={handleSubmit} action="">
          <div className="lg:mt-4 mt-2 ">
            <div className="flex flex-col  gap-4">
              ...
              <div className="flex justify-end  gap-5 ml-10  ">
                <div className="  ">
                  <Button   className=" sliderBtn1" onClick={handleSecondCancelModal}>
                    Back
                  </Button>
                </div>
                <div>
