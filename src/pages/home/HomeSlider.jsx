                ...
                >
                  <div className="  ">
                    ...
                    <div className=" flex items-center gap-2 mt-4  ">
                      ...
                      <div>
                        <h1 className=" text-[16px] text-[#263234] leading-6 ">
                          Please input your auction details to help buyer find
                          out exactly their needs.
                        </h1>
                      </div>
                    </div>
                    {/* step */}
                    ...
                    >
                      ...
                      <div className="flex lg:flex-row md:flex-row flex-col justify-end lg:gap-16">
                        <Button
                  ...
                  >
                    <div className="  ">
                      ...
                      <div className=" flex items-center gap-2 mt-4  ">
                        ...
                        <div>
                          <h1>
                            Help us to collecting your auction item by providing
                            your information <br /> accurate.
                          </h1>
                        </div>
                      </div>
                      {/* step */}
                  ...
                  <div className="flex items-center gap-2 mt-4 ">
                    ...
                    <div>
                      <p className="text-[#263234]">
                        Once your auction is sold out, you will get paid and
                        donation amount will be funded to the Virtue Hope.
                      </p>
                    </div>
                  </div>
                  {/* step */}
              ...
              >
                <div className="  ">
                  ...
                  <div className=" flex items-center gap-2 mt-4  ">
                    ...
                    <div>
                      <h1 className=" text-[16px] text-[#263234] leading-6 ">
                        Please input your auction details to help buyer find out
                        exactly their needs.
                      </h1>
                    </div>
                  </div>
                  ...
                  <Form layout="vertical" className=" p-6   rounded-lg">
                    ...
                    <Form.Item
                      ...
                      rules={[
                        {
                          required: true,
                          message: "Please enter your auction title!",
                        },
                      ]}
                    >
                      <Input
                    ...
                    <Form.Item
                      style={{ marginBottom: "0px" }}
                      label={
                        <span className=" text-sm text-[#263234] mt-2 font-medium ">
                          Item description
                        </span>
                      }
                      name="description"
                      rules={[
                        {
                          required: true,
                          message: "Please enter your item description!",
                        },
                      ]}
                    >
                      <div className="mb-4">
                    ...
                    <Form.Item style={{ marginBottom: "0px" }} name={"image"}>
                      <div className="mb-4">
                        <Dragger
                          style={{
                            marginTop: "6px",
                    ...
                    <Radio.Group className="w-full">
                      <div className="flex flex-col gap-4">
                        ...
                        >
                          ...
                          <span className="block lg:ml-[470px]! md:ml-[240%] ml-[170%] -mt-6 ">
                            {/* Apple Pay Icon */}
                            <svg
                              width="20"
                              height="24"
                        ...
                        >
                          ...
                          <span className="lg:ml-[470px]! md:ml-[220%] ml-[155%] block -mt-6 ">
                            {/* Google Pay Icon */}
                            <svg
                              width="24"
                              height="24"
                        ...
                        >
                          ...
                          <span className="block  lg:ml-[465px]! md:ml-[210%] ml-[140%] -mt-6 ">
                            {/* paypal Pay Icon */}
                            <svg
                              width="24"
                              height="24"
                    ...
                    <Radio.Group className="w-full">
                      <div className="flex flex-col gap-4">
                        ...
                        >
                          ...
                          <span className="block  lg:ml-[265px]! md:ml-[210%] ml-[140%] -mt-6 ">
                            {/* paypal Pay Icon */}
                            <svg
                              width="24"
                              height="24"
