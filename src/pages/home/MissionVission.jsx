...
export const MissionVission = () => {
  ...
  return (
    <div className="py-5 px-4 max-w-[1512px] mx-auto bg-[#ecebea]">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="bg-white shadow lg:pt-[127px] lg:px-[64px] p-4 rounded-2xl">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-4">
            ...
            <button className="bg-[#F6F6F7] text-gray-800 py-3 px-6 rounded-md font-bold">
              Become a volunteer
            </button>
          </div>
        </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center  bg-opacity-50 z-50">
          <div className="bg-white w-96 p-6 rounded-lg shadow-lg relative">
            {/* Modal Title */}
            <h2 className="text-2xl font-semibold leading-8 text-[#263234]">
            ...
            <div className="mt-4">
              <div className="flex flex-col gap-4">
                <label className="flex items-center justify-between w-full p-4 border border-[#A6ABAC]  rounded-lg cursor-pointer">
                  {/* payple */}
                ...
                <label className="flex items-center justify-between mt-2 w-full p-4 border border-[#A6ABAC] rounded-lg cursor-pointer">
                  <div className="flex items-center gap-2">
                    <input
                      type="radio"
                      name="donation"
              ...
              <label className="flex items-center justify-between w-full p-3 border border-[#A6ABAC]  rounded-lg cursor-pointer">
                <div className="flex items-center gap-2">
                  <input
                    type="radio"
                    name="donation"
      ...
      {donateModal && (
        <div className="fixed inset-0 flex items-center justify-center max-w-[600px]  bg-opacity-50 z-50">
          {/* Donation Options */}
          <div className="fixed inset-0 flex items-center justify-center ">
            <div className="bg-white w-[500px] py-6 px-6 rounded-2xl shadow-lg">
              {/* Title */}
              <h2 className="text-2xl font-semibold leading-8 py-6 text-[#263234] mb-4">
