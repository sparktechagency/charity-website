...
const ContactFrom = () => {
  ...
  const donateFull = Form.useWatch("fullDonation", form);
      ...
      <div className="max-w-[620px] mx-auto rounded -z-0 shadow border-[#a6abac] border px-6">
        ...
        <Form onFinish={submitForm} form={form} layout="vertical">
          ...
          <Form.Item
            name="percentage"
            label={
              <span className="text-sm text-[#263234] font-medium">Donate</span>
            }
          ...
          >
            <Checkbox style={{ color: "#263234", fontSize: "14px" }}>
              ...
              <span className=" underline " onClick={opneModal} style={{ color: "#263234" }}>
                terms & conditions
              </span>
              .
            </Checkbox>
