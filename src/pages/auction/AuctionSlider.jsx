                        ...
                        <div className="relative flex flex-col items-end w-full">
                          <div className="flex">
                            ...
                            <button
                              ...
                              className="flex items-center gap-2 cursor-pointer bg-[#403730] text-white text-sm font-semibold px-2 py-2.5 hover:bg-[#2c241f] transition w-fit"
                            >
                              Bid online
                            </button>
          ...
          >
            ...
            >
              ...
              >
                <Input
                  prefix={<span>
                    <svg width="19" height="20" viewBox="0 0 25 20" fill="none" xmlns="http://www.w3.org/2000/svg">
